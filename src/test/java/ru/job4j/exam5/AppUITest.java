...
public class AppUITest {
    ...
    public void whenUser3User5Same() {
        ...
        String expected =
                ...
                + "user3 -> vasya@rambler.ru, xyz@pisem.net\r\n"
    ...
    @Test
    public void whenUser1User2MultiSameMails() {
        Input in = new StubInput(new String[] {
                "2",
                "user1 -> xxx@ya.ru, foo@gmail.com, foo@abc.net",
                "user2 -> foo@gmail.com, ups@nix.ru, foo@abc.net"
        });
        StubOutput out = new StubOutput();
        Input vin = new ValidateInput(in, out);
        AppUI ui = new AppUI(vin, out);
        String expected =
                "user1 -> ups@nix.ru, foo@abc.net, xxx@ya.ru, foo@gmail.com\r\n";
        ui.execute();
        assertEquals(expected, out.toString());
    }
}